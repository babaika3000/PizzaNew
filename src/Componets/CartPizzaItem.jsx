...
import {addItems, minusItem, clearCart, removeItem} from "../redux/redusers/cartSilce";

const CartPizzaItem = ({id, price, title,imageUrl,type,size, count }) => {
...
const ooClickRemove =()=>{
  ...
  return (
    <div className="cart__item">
      ...
      <div onClick={ooClickRemove} className="cart__item-remove">
